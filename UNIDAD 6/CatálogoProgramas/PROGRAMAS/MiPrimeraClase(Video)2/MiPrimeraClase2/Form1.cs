...
namespace MiPrimeraClase2
{
    public partial class frmPersonas2 : Form
    {
        ...
        private void frmPersonas2_Load(object sender, EventArgs e)
        {
            ...
            Archivo = new StreamWriter("DatosID2.txt");
            Archivo2 = new StreamWriter("DatosNombre2.txt");
            Archivo3 = new StreamWriter("DatosApellidos2.txt");
            Archivo4 = new StreamWriter("DatosCorreo2.txt");
            Archivo5 = new StreamWriter("DatosFecha2.txt");
            Archivo6 = new StreamWriter("DatosSalario2.txt");
        }
